...
public class ListTeamAdapter extends BaseAdapter {
    private final List<com.ronald.football_app.data.Team> teams;
    private final Context context;

    public ListTeamAdapter(Context context, List<com.ronald.football_app.data.Team> teams){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final com.ronald.football_app.data.Team team = teams.get(i);
